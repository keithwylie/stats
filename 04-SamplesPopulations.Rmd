...
:::point
**Probability** assumes a state of the world, like that a coin is fair. **Statistical inference** lets us extrapolate from a set of observations to assume a state of the world, like whether or not a coin is probably fair.
:::
