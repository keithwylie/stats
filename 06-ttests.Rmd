...
:::source
This chapter is adapted almost verbatim from Danielle Navarro's Learning Statistics.
:::
...
It turns out this was a very nice thing for Gosset to have done. t tests are used all the time to compare samples. In this chapter we learn how they work.

In general, you have already been thinking about the things you need to think about to understand t tests. You're probably wondering what is this $t$, what does $t$ mean? We will tell you. Before we tell what it means, we first tell you about one more idea.
